...
echo: true
aliases:
  - /applications/application1.html
---
...
Pour l'exercice 4.3, nous aurons besoin de la structure de requête suivante pour créer la variable "in_triangle" :
