...
#| output: false
dir.create("data")
download.file("https://minio.lab.sspcloud.fr/projet-formation/nouvelles-sources/data/triangle.geojson", "data/triangle.geojson", method="curl", extra="--retry 5 --retry-all-errors --max-time 15")
download.file("https://minio.lab.sspcloud.fr/projet-formation/nouvelles-sources/data/malakoff.geojson", "data/malakoff.geojson", method="curl", extra="--retry 5 --retry-all-errors --max-time 15")
download.file("https://minio.lab.sspcloud.fr/projet-formation/nouvelles-sources/data/montrouge.geojson", "data/montrouge.geojson", method="curl", extra="--retry 5 --retry-all-errors --max-time 15")
download.file("https://minio.lab.sspcloud.fr/projet-formation/nouvelles-sources/data/geoparquet/dvf.parquet", "data/dvf.parquet", method="curl", extra="--retry 5 --retry-all-errors --max-time 15")
download.file("https://minio.lab.sspcloud.fr/projet-formation/nouvelles-sources/data/geoparquet/carreaux.parquet", "data/carreaux.parquet", method="curl", extra="--retry 5 --retry-all-errors --max-time 15")
```
