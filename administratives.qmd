...
ou encore le référentiel national des bâtiments (RNB, en cours d'élaboration), sont
...
En France, le centre d'accès sécurisé à distance ([CASD](https://www.casd.eu/)) permet cependant dorénavant d'accéder à distance à des bases et des données individuelles, principalement
administratives, à la fois pour les administrations et pour les chercheurs.
