...
La statistique publique gère de nombreux autres répertoires que vous pouvez croiser parfois
...
- le répertoire national d'identification des personnes physiques (RNIPP) : répertoire géré par l'Insee qui identifie, à partir des actes d'état civil, les personnes en France et leur attribue un numéro, plus connu sous le nom de "numéro de sécurité sociale"
- le Répertoire national des identifiants élèves, étudiants et apprentis : géré par le SSM Enseignement supérieur et Recherche,
ce registre attribue un numéro unique à tous les élèves (le fameux numéro INE).
...
:::{.callout-note}
## Les DADS et la DSN
La DSN est venue moderniser et remplacer la DADS, qui n'est aujourd'hui plus utilisée.
Plus d'informations sur le site de l'Insee :
-  la [Déclaration annuelle de données sociales](https://www.insee.fr/fr/metadonnees/source/serie/s1163) (DADS) ;
-  la [Déclaration sociale nominative](https://www.insee.fr/fr/information/3647025?sommaire=3647035) (DSN).
:::
